<template>
  <div>
    <el-tabs tab-position="left" class="demo-tabs">
      <el-tab-pane label="入队审核">
        <VolToTeam />
      </el-tab-pane>
      <el-tab-pane label="入项审核">
        <VolToProject />
      </el-tab-pane>
      <el-tab-pane label="我的项目">
        <MyProject />
      </el-tab-pane>
      <el-tab-pane label="我的成员">
        <MyVol />
      </el-tab-pane>
      <el-tab-pane label="项目审核">
        <ProjectCheck />
      </el-tab-pane>
      <el-tab-pane label="队伍审核">
        <TeamCheck />
      </el-tab-pane>
    </el-tabs>
  </div>
...
import MyVol from '../center/team/MyVol.vue'
import MyProject from '../center/team/MyProject.vue'
export default {
  components: {
    ProjectCheck,
    TeamCheck,
